...
class univ_ratio:
    def __init__(self,server_message):
      ...
      #You can check ratio data that you want to find for using IF & For 
      #Input class information for seraching Univ class...
      
        '''
        for i in range(len(data99)):
            if data99[i] == "Univ_Class":
                print(i)
        '''
